define(function(require) {
    ...
    Handlebars.registerHelper('enum',
    function(value, id) {
        if (enums[id])
    ...
    function(start, end, modificator, options) {
